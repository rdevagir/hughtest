trigger GRAXCertification on Certification__c (after update,after insert,after delete,after undelete) {
    // -------------------------------------------------
    // https://GRAX.io/
    ...
    try {
        ...
        System.debug('[Trigger GRAXCertification] ' + ex.getMessage());
    }
}