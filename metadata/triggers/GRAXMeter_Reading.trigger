trigger GRAXMeter_Reading on Meter_Reading__c (after update,after insert,after delete,after undelete) {
    // -------------------------------------------------
    // https://GRAX.io/
    ...
    try {
        ...
        System.debug('[Trigger GRAXMeter_Reading] ' + ex.getMessage());
    }
}